...
help:
	...
	@echo "  run-all            Run all 10 campaigns sequentially (mock)"
	@echo "  run-real-all       Run all 10 campaigns sequentially (real)"
	...
	@echo "  test-campaigns     Validate all 10 campaign YAMLs parse correctly"
	@echo "  fmt                Run go fmt"
	@echo "  vet                Run go vet"
